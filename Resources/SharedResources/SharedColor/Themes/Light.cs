...
{
    internal class Light : ResourceDictionary
    {
        ...
        public Light()
        {
            ...
            if (app != null && app.Resources != null)
            {
                ...
                this["TertiaryBrush"] = (MauiColor)app.Resources["blue500"];
                this["BackgroundBrush"] = (MauiColor)app.Resources["white500"];
                this["SurfaceBrush"] = (MauiColor)app.Resources["gray300"];
                this["TextBrush"] = (MauiColor)app.Resources["black900"];
                this["TextHeaderBrush"] = (MauiColor)app.Resources["purple800"];
                this["TextSubHeaderBrush"] = (MauiColor)app.Resources["purple600"];
                this["MuteTextBrush"] = (MauiColor)app.Resources["gray600"];
                ...
                this["ShadowBrush"] = (MauiColor)app.Resources["gray400"];
